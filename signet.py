...
def test_sample(n_way, n_support, n_query, test_x, test_y):
    my_sample = extract_sample(n_way, n_support, n_query, test_x, test_y)
    my_loss, my_output = model.set_forward_loss(my_sample)

    return my_output["y_hat"]

if __name__ == '__main__':

    train_x, train_y = read_images('sign_background')
    test_x, test_y = read_images('sign_evaluation')
    ...
    torch.torch.save(model.state_dict(), 'my_sign_model.pt')